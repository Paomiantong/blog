      ...
      >
        ...
        >
          <div className="navbar__logo">
            <img src={require("@site/static/Logo.png").default} />
          </div>
          <div
          ...
          >
            ...
            <button
              title={
                colorMode === "light" ? "切换为暗色模式" : "切换为亮色模式"
              }
              style={{
                background: "none",
                color: "var(--ifm-color-white)",
            ...
            >
              {colorMode === "light" ? (
                <svg
                  ...
                  width="24"
                  height="24"
                  className="lightToggleIcon_dnYY"
                >
                  <path
                    fill="currentColor"
          ...
          {author?.social_links?.map(({ name, url, icon }, index) => (
            <a
              ...
              style={{
                ...
                alignItems: "center",
                marginRight:
                  index === author?.social_links?.length - 1 ? "0" : "1rem",
                marginBottom: "0.5rem",
              }}
            >
